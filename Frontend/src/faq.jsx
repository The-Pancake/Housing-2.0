...
const Faq = ({ hidden }) => {
    ...
    const faqs = [
        ...
        {
            question:
                "What if I do not pre-select a roommate in the application?",
        ...
        {
            question:
                "How do I learn more about the amenities and features of each residence hall?",
        ...
        {
            question:
                "What are my options if I have a medical condition or unique situation that will require a special housing accommodation?",
        ...
        {
            question:
                "What are Special Interest Housing communities and can first-year students enroll in these communities?",
